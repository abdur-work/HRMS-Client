...
export class BankDetailComponent {
  ...
  constructor(private toastrService: ToastrService, private spinnerService: NgxSpinnerService,
    ...
    this.route.params.subscribe(params => {
      ...
      this.employeeId = this.employeeId ? this.employeeId : this.userContextService.user$._value.employeeId;
    });
    const userRoles: any = this.userContextService.getUserRoles();
    this.isAddAccess = userRoles.includes(114);
    this.isDeleteAccess = userRoles.includes(116);
  }
