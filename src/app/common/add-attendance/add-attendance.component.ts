...
export class AddAttendanceComponent {
  ...
  constructor(@Inject('data') public data: any, private injector: Injector, private toastrService: ToastrService,
    ...
    if (this.data && this.data.attendanceModel && this.data.attendanceModel.action === 'update')
  ...
  setUpdateAttendanceModel() {
    this.attendanceModel.checkedIn = this.data.attendanceModel.checkedIn;
    this.attendanceModel.checkedOut = this.data.attendanceModel.checkedOut;
    this.attendanceModel.action = 'update';
    this.attendanceModel.employeeAttendanceID = this.data.attendanceModel.employeeAttendanceID;
  }
